...
ow.util:LoadFolder("framework/libs")
ow.util:LoadFolder("framework/thirdparty")
ow.util:LoadFolder("framework/thirdparty/paint")
ow.util:LoadFolder("framework/meta")
ow.util:LoadFolder("framework/derma")
ow.util:LoadFolder("framework/hooks")
ow.util:LoadFolder("framework/net")
ow.util:LoadFolder("framework/languages")
...
ow.util:LoadFile("framework/sh_cami.lua")
ow.util:LoadFile("framework/sh_characters.lua")
ow.util:LoadFile("framework/sh_chat.lua")
ow.util:LoadFile("framework/sh_colors.lua")
ow.util:LoadFile("framework/sh_commands.lua")
ow.util:LoadFile("framework/sh_configs.lua")
ow.util:LoadFile("framework/sh_options.lua")
