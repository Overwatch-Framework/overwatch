-- Default colors
ow.color:Register("white", color_white)
ow.color:Register("black", color_black)
ow.color:Register("red", Color(255, 0, 0, 255))
ow.color:Register("green", Color(0, 255, 0, 255))
ow.color:Register("blue", Color(0, 0, 255, 255))
ow.color:Register("yellow", Color(255, 255, 0, 255))
ow.color:Register("orange", Color(255, 165, 0, 255))
ow.color:Register("purple", Color(130, 0, 130, 255))
ow.color:Register("pink", Color(255, 190, 205, 255))
ow.color:Register("cyan", Color(0, 255, 255, 255))
ow.color:Register("brown", Color(165, 40, 40, 255))
ow.color:Register("gray", Color(130, 130, 130, 255))
ow.color:Register("light.gray", Color(210, 210, 210, 255))
ow.color:Register("dark.gray", Color(170, 170, 170, 255))
ow.color:Register("lime", Color(0, 255, 0, 255))
ow.color:Register("maroon", Color(130, 0, 0, 255))
ow.color:Register("navy", Color(0, 0, 130, 255))
ow.color:Register("olive", Color(130, 130, 0, 255))
...
ow.color:Register("gmod.console.error.client", Color(255, 221, 102, 255))
