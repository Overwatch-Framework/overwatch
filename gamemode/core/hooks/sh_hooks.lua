...
function GM:GetFrameworkColour()
    return ow.config:Get("colour.framework", Color(95, 255, 220))
end

function GM:GetSchemaColour()
    return ow.config:Get("colour.schema", Color(0, 150, 100))
end
